...
export default function ServiceCard({ title, description, link, imageSrc, color }: ServiceCardProps) {
    return (
        <div className="group bg-white rounded-2xl p-8 h-full border border-gray-100 hover:border-transparent hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 relative overflow-hidden">
            {/* Top Border Accent */}
